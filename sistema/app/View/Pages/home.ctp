<div class="col-md-12">
	...
	<div class="col-md-10">
		<h1><strong>NFCHURCH - Sistema de Gestão para Igrejas</strong></h1>
	</div>
	<div class="col-md-1">
	</div>
</div>
...
<div class="col-md-12">
	<div id="myCarousel" class="carousel slide col-md-12">
		...
		<!-- Carousel nav -->
		<a class="carousel-control left arrow" href="#myCarousel" data-slide="prev"><</a>
		<a class="carousel-control right arrow" href="#myCarousel" data-slide="next">></a>
	</div>
</div>