<?php
	...
	echo $this->Form->input('tipo', array('label' => 'Tipo:', 'options' => ['1' => 'Membro', '2' => 'Visitante'], 'default' => '2', 'class' => 'form-control', 'div' => array('class' => 'form-group col-md-2')));
	echo $this->Form->input('nome', array('label' => 'Nome:', 'class' => 'form-control', 'div' => array('class' => 'form-group col-md-6')));
	echo $this->Form->input('sexo', array('label' => 'Sexo:', 'options' => array('' => 'Selecione', '1' => 'Masculino', '2' => 'Feminino'), 'class' => 'form-control', 'div' => array('class' => 'form-group col-md-3')));
	...
	echo $this->Form->input('Endereco.estado_id', array('label' => 'Estado', 'options' => $estados, 'class' => 'form-control', 'div' => array('class' => 'form-group col-md-6')));
	?>
