<?php 
	...
	echo $this->Form->input('nome', array('label' => 'Nome Denominação:', 'class' => 'form-control col-md-12', 'div' => array('class' => 'form-group col-md-12'), 'required' => 'required'));
...
<?php
	echo $this->Form->input('Salvar Denominação', array('type' => 'submit', 'label' => false, 'class' => 'btn btn-success form-control', 'div' => array('class' => 'form-group col-md-4'), 'id' => 'salvar_dados'));
 ?>