<div class="row">
  ...
  <div class="col-md-3">
    <section class="panel">
      <div class="panel-body">
        <div class="top-stats-panel">
          <h4 class="widget-h">Vendedores</h4>
          <div class="sm-pie">
          </div>
        </div>
      </div>
        ...
        <div class="top-stats-panel">
          ...
          <div class="bar-stats">
            <ul class="progress-stat-bar clearfix">
              ...
              <li data-percent="2%"><span class="progress-stat-percent yellow-b"></span></li>
            </ul>
            <ul class="bar-legend">
              <li><span class="bar-legend-pointer pink"></span> Visitantes</li>
              <li><span class="bar-legend-pointer green"></span> Novos Membros</li>
              <li><span class="bar-legend-pointer yellow-b"></span> Familiáres</li>
            </ul>
            <div class="daily-sales-info">
              <span class="sales-count">8 </span> <span class="sales-label">Novos Membros</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="todo-action-bar">
        <div class="row">
          ...
          <div class="col-xs-6 todo-search-wrap">
            <input type="text" class="form-control search todo-search pull-right" placeholder=" Procurar">
          </div>
