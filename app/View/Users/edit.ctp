                ...
                <div id="wizard">
                    ...
                    <section>
                        <?php echo $this->Form->create('User') ?>
                            ...
                            <div class="form-group">
                                <div class="col-lg-8">
                                    <?php echo $this->Form->input('password', array('type' => 'text', 'class' => 'form-control', 'label' => 'Sua Senha:', 'placeholder' => 'Digite sua senha:')) ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-8">
                                    <?php echo $this->Form->input('repassword', array('type' => 'text', 'label' => 'Repita Sua Senha:', 'class' => 'form-control', 'placeholder' => 'Digite sua senha novamente')); ?>
                                </div>
                            </div>
                             <div class="form-group">
                                <div class="col-lg-8">
