    ...
    <div class="bs-sidebar hidden-print affix lateral" role="complementary">
      <ul id="menu" class="nav bs-sidenav">
        <li class="parent"><a href="#"><span class="glyphicon glyphicon-briefcase"></span> Secretaria</a>
          <ul class="sub-menu">
            <li><?php echo $this->Html->link('Pessoas', array('plugin' => 'secretaria', 'controller' => 'membros', 'action' => 'index'));?></li>
            <li><?php echo $this->Html->link('Cadastros', array('plugin' => 'secretaria', 'controller' => 'membros', 'action' => 'add'));?></li>
