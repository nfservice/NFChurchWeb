<?php 
	echo $this->Form->create(array('Editora', 'role' => 'form', 'class' => 'formModal'));
...
<?php
	echo $this->Form->input('Salvar Editora', array('type' => 'submit', 'label' => false, 'class' => 'btn btn-success form-control', 'div' => array('class' => 'form-group col-md-4'), 'id' => 'salvar_dados'));
 ?>