	...
	<div class="panel menuRoll">
		<div class="panel-body row">
			...
			<div class="form-group col-md-4">
				<a class="btn btn-success form-control btnModal" onclick="modalLoad('<?php echo $this->Html->url(array("plugin" => "secretaria", "controller" => "cargos", "action" => "add")); ?>');"><i class="fa fa-plus"></i> Adicionar Cargo</a>
			</div>
