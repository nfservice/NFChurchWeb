        ...
        <?php
            ...
            foreach ($this->request->data['Relacionamento'] as $relacionamento) { ?>
                ...
                <?php 
                    ...
                    echo $this->Form->input('Relacionamento.'.$i.'.membro2_id', array('label' => 'Parente', 'empty' => 'Selecione um membro', 'class' => 'form-control', 'placeholder' => 'Nome Parente', 'required', 'div' => array('class' => 'form-group col-md-8'), 'options' => $parentes, 'default' => $relacionamento['membro2_id']));
