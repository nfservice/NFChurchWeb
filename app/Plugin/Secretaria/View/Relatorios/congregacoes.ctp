    ...
    <section class="panel">
        ...
        <div class="panel-body">
        	<?php 
				...
				echo $this->Form->input('nome', array('class' => 'form-control', 'label' => 'Nome:', 'div' => array('class' => 'form-group col-md-8')));
				echo $this->Form->input('bairro', array('class' => 'form-control', 'label' => 'Bairro:', 'div' => array('class' => 'form-group col-md-4')));
