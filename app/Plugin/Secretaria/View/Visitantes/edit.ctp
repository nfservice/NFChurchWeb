<div class="col-lg-12">
	...
	echo $this->Form->input('datanascimento', array('label' => 'Data de Nascimento:', 'type' => 'text', 'class' => 'form-control col-md-6', 'div' => array('class' => 'form-group col-md-2')));
	echo $this->Form->input('email', array('label' => 'E-mail:', 'type' => 'email', 'class' => 'form-control', 'div' => array('class' => 'form-group col-md-6')));
