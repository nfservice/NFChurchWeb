...
<script type="text/javascript">
	...
	function addMovimentacao()
	{
	    ...
	    $('#remove'+next).html('<a href="javascript:;" onclick="delMovimentacao('+next+');" class="btn btn-danger form-control"><i class="fa fa-trash-o"</i></a>');
	    cont++;
	    next++;
	}
...
<?php
	...
	echo $this->Form->input('files.', array('type' => 'file', 'multiple', 'div' => array('class' => 'form-group col-md-12')));
	?>
	...
	<div id="all">
		<div id="movimentacao0">
			...
			?>
			<div id="remove0" class="row">

			</div>
		</div>
	</div>
	<div class="col-md-12 form-group">
		<a href="javascript:;" class="btn btn-primary form-control col-md-12" onclick="addMovimentacao();">Adicionar</a>
	</div>
